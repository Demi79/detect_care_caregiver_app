...
/// Model for burst screenshot response
...
/// Model for thumbnail refresh response
...
/// Model for latest thumbnail response
...
/// Camera Screenshot API Service
/// Handles all screenshot and thumbnail capture operations
class CameraScreenshotApi {
  final ApiClient apiClient;

  CameraScreenshotApi(this.apiClient);

  /// Capture screenshot from RTSP stream (on-demand)
  ///
